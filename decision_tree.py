...
if __name__ == '__main__':
    data = pd.read_csv(r'../data/500_Person_Gender_Height_Weight_Index.csv')
    data['obese'] = (data.Index >= 4).astype('int')
    data.drop('Index', axis=1, inplace=True)

    # weight_ig, weight_slpit, _, _ = max_information_gain_split(x=data['Weight'], y=data['obese'], )
    max_depth = 5
